...
//    this.mMsg.setText(this.kDelta);
    ...
    // For the Caption B
    if (this.judgeArea(55, 65, 3) && (this.mCaptionB.isRead == false)) {
    ...
    // For the Caption C
    if (this.judgeArea(55, 95, 3) && (this.mCaptionC.isRead == false)) {
    ...
    // For the Caption D
    if (this.judgeArea(85, 95, 3) && (this.mCaptionD.isRead == false)) {
